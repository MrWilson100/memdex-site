...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden">
      ...
      <div className="relative z-10 pt-28 pb-28 lg:pt-36 lg:pb-36">
        {/* Background image */}
      ...
      <div className="relative h-[280px] sm:h-[400px] lg:h-[500px] overflow-hidden">
        ...
        {/* Horizon glow */}
        <div className="absolute top-0 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[var(--silver)] to-transparent opacity-40 z-20" />
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-32 h-32 bg-white/20 blur-3xl z-20" />

        {/* Title text - below the blue line */}
        <div className="absolute top-[60px] sm:top-[120px] left-0 right-0 text-center z-20 px-4">
          <p
            className="text-white/70 text-base sm:text-xl lg:text-2xl tracking-widest uppercase"
            style={{ fontFamily: "var(--font-memdex)" }}
          >
