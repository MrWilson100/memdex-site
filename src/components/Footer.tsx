  ...
  return (
    <footer className="relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <div className="flex flex-col lg:flex-row justify-between gap-12">
            ...
            <div>
              ...
              <p className="text-[#a0c4ff] mb-2">Follow Us for Updates and Insights</p>
              <p className="text-[#a0c4ff] mb-6">Privacy Policy Accessibility Statement</p>
              ...
              <div className="flex gap-4">
                ...
                <a
                  ...
                  className="w-10 h-10 rounded-full border border-[#4d8bff]/50 flex items-center justify-center text-white hover:bg-[#4d8bff]/20 transition-colors"
                >
            ...
            <div className="w-full lg:w-auto">
              <form onSubmit={handleSubmit}>
                ...
                <input
                  ...
                  required
                  className="w-full lg:w-80 px-4 py-3 bg-white text-black rounded-none border-2 border-black mb-4 focus:outline-none focus:border-[#4d8bff]"
                />
                <button
                  type="submit"
      ...
      <div className="relative h-[400px] lg:h-[500px] overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-b from-[#0a1628] to-[#050a12]" />
        ...
        {/* Horizon glow */}
        <div className="absolute top-1/4 left-0 right-0 h-1 bg-gradient-to-r from-transparent via-[#4d8bff] to-transparent opacity-80 z-20" />
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-32 h-32 bg-white/30 blur-3xl z-20" />
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#050a12] via-transparent to-transparent pointer-events-none" />
      </div>
    </footer>
  );
}
